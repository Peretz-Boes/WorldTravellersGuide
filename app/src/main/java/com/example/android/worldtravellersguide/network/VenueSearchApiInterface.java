...
public interface VenueSearchApiInterface {
    @GET("search/recommendations?v=20160504")
    ...
    @GET("search/recommendations?v=20160504")
    Call<FoursquareRootJSON>searchRandomVenueNearMe(@Query("client_id") String clientID,@Query("client_secret") String clientSecret,@Query("query") String query,@Query("ll") String ll,@Query("llAcc") double llAcc);
}
